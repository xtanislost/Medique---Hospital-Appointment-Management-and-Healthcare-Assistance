...
        // New fields
        const [placeOfExperience, setPlaceOfExperience] = useState('');
...
                // New fields
                formData.append('placeOfExperience', placeOfExperience);
                formData.append('qualificationDetails', qualificationDetails);
                formData.append('doctorLicenseNumber', doctorLicenseNumber);
...
            </div>
            <div className="flex-1 flex flex-col gap-1">
              <p>Place of Experience</p>
              <input onChange={(e)=> setPlaceOfExperience(e.target.value)} value={placeOfExperience}
                className="border rounded px-3 py-2"
                type="text"
...
              <input onChange={(e)=> setQualificationDetails(e.target.value)} value={qualificationDetails}
                className="border rounded px-3 py-2"
                type="text"
...
            </div>
            <div className="flex-1 flex flex-col gap-1">
              <p>Doctor License Number</p>
              <input onChange={(e)=> setDoctorLicenseNumber(e.target.value)} value={doctorLicenseNumber}
                className="border rounded px-3 py-2"
                type="text"
